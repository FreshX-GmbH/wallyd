...
// Simplified version
int ht_contains_simple(hash_table *table, char *key);

//  @brief See if the key has value *value
/// @param table A pointer to the hash table.
/// @param key A pointer to the key.
/// @param value The value to compare
//  @returns See return value of strncmp
int ht_compare(hash_table *table, char *key, char *value);
...
/// @brief Dumps all keys in a table
/// @param table A pointer to the table
/// @param prefix The prefix to print in from of the dump
